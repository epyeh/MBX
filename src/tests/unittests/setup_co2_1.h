...
#define SETUP_CO2_1                                                                                           \
    double classic_energy = 437.45949;                                                                        \
    ...
    Bond bond1 = Bond("bond", std::vector<size_t>{1, 2}, "morse");                                            \
    Bond bond2 = Bond("bond", std::vector<size_t>{1, 3}, "morse");                                            \
    Angles angle1 = Angles("angle", std::vector<size_t>{1, 2, 3}, "harm");                                    \
